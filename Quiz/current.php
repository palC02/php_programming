<?php
$score = 0;
$correct_answers = array("q1" => "a", "q2" => "c", "q3" => "a", "q4" => "a", "q5" => "a");
$feedback = array();
...
<div class="quiz-container">
    ...
    <form method="post">
        <div class="question">
            <p>1. Who was elected as the current President of America ?</p>
            <ul class="options">
                <li><input type="radio" name="q1" value="a" <?php if (isset($_POST['q1']) && $_POST['q1'] == 'a') echo 'checked'; ?>> Donald Trump</li>
                <li><input type="radio" name="q1" value="b" <?php if (isset($_POST['q1']) && $_POST['q1'] == 'b') echo 'checked'; ?>> Hilary Clinton</li>
                <li><input type="radio" name="q1" value="c" <?php if (isset($_POST['q1']) && $_POST['q1'] == 'c') echo 'checked'; ?>> Joe Biden</li>
            </ul>
        </div>
